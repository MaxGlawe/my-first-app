...
interface NewFunktionsuntersuchungPageProps {
...
export default function NewFunktionsuntersuchungPage({ params }: NewFunktionsuntersuchungPageProps) {
  const { id } = use(params)
  ...
  if (!isFunktionsRole && !isAdmin) {
    return (
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        <Alert variant="destructive">
          <AlertDescription>
            Zugriff verweigert. Funktionsuntersuchungen können nur von Trainern erstellt werden.
          </AlertDescription>
        </Alert>
      </div>
    )
    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Neue Funktionsuntersuchung</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight">Neue Funktionsuntersuchung</h1>
      ...
      <FunktionsuntersuchungForm patientId={id} />
    </div>
  )
}
