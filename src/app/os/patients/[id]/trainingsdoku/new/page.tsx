...
interface NewTrainingsdokuPageProps {
...
export default function NewTrainingsdokuPage({ params }: NewTrainingsdokuPageProps) {
  const { id } = use(params)
    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      <Breadcrumb className="mb-6">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Neue Trainingsdokumentation</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight">Neue Trainingsdokumentation</h1>
      ...
      <TrainingsdokuForm patientId={id} />
    </div>
  )
}
