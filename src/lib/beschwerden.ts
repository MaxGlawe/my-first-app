...
export const BESCHWERDEN: Beschwerde[] = [
  {
    ...
    faq: [
      ...
      { question: "Was kostet die Online-Physiotherapie bei Rückenschmerzen?", answer: "Das 90-Tage-Programm von Praxis OS kostet 499€ einmalig; die vorausgegangene Videokonsultation ist darin enthalten. Die Terminbuchung selbst kostet nichts. Abgerechnet wird erst nach dem Gespräch — entweder das Programm, oder 69€ für die Konsultation allein, wenn Sie sich dagegen entscheiden. Abgerechnet wird über eine Heilpraktiker-Rechnung; die gesetzliche Krankenkasse übernimmt die Kosten nicht." },
    ],
