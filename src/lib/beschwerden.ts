...
export const BESCHWERDEN: Beschwerde[] = [
  {
    ...
    faq: [
      ...
      { question: "Was kostet die Online-Physiotherapie bei Rückenschmerzen?", answer: "Das 90-Tage-Programm von Praxis OS gibt es in zwei Varianten: „Begleitet“ für 299€ einmalig, mit Betreuung über Chat und App, und „Intensiv“ für 499€ einmalig, zusätzlich mit acht Video-Sitzungen. Die vorausgegangene Videokonsultation ist in beiden enthalten. Bei der Terminbuchung wird noch nichts abgebucht. Abgerechnet wird nach dem Gespräch — entweder der Betrag der gewählten Variante oder 69€ für die Konsultation allein, wenn Sie sich dagegen entscheiden. Abgerechnet wird über eine Heilpraktiker-Rechnung; die gesetzliche Krankenkasse übernimmt die Kosten nicht." },
    ],
