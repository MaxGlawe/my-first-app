...
export const BESCHWERDEN: Beschwerde[] = [
  {
    ...
    faq: [
      ...
      { question: "Was kostet die Online-Physiotherapie bei Rückenschmerzen?", answer: "Die Video-Analyse (30 Min.) kostet 69€ einmalig. Im Anschluss können Sie Ihre Behandlung über die Betreuungspauschale (16,99€/Monat, jederzeit kündbar) fortsetzen. Für chronische Rückenschmerzen bieten wir individuelle Behandlungspakete an — den passenden Umfang besprechen wir persönlich in der Analyse." },
    ],
