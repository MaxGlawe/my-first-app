...
export const BESCHWERDEN: Beschwerde[] = [
  {
    ...
    faq: [
      ...
      { question: "Was kostet die Online-Physiotherapie bei Rückenschmerzen?", answer: "Das 90-Tage-Programm von Praxis OS kostet 499€ einmalig; die vorausgegangene Videokonsultation ist darin enthalten. Bei der Terminbuchung wird noch nichts abgebucht. Abgerechnet wird nach dem Gespräch — entweder 499€ für das Programm, in denen die Konsultation enthalten ist, oder 69€ für die Konsultation allein, wenn Sie sich dagegen entscheiden. Abgerechnet wird über eine Heilpraktiker-Rechnung; die gesetzliche Krankenkasse übernimmt die Kosten nicht." },
    ],
