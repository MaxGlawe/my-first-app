/**
 * Masterclass „Chronischer Kreuzschmerz" — Source of Truth für Lektion 3.4
 * ========================================================================
 *
 * DIES IST DIE QUELLE. `src/lib/masterclass/lessons/3.4.ts` wird DARAUS generiert
 * (via `node scripts/build-masterclass.mjs 3.4`). Niemals lessons/3.4.ts von Hand
 * editieren — immer hier ändern und das Build-Skript neu laufen lassen.
 *
 * Letzte Lektion von Modul 3 (Prävention) und zugleich die Brücke zu Modul 4
 * (Recoping/Habit Stacking). „Bewegung im Alltag statt Workout-Mentalität": die
 * Verschiebung weg von der Workout-Mentalität (Bewegung als Termin) hin zur
 * Bewegungs-Lebensweise. Themenblöcke / Slide-Gruppen klar getrennt:
 *   - Workout-Mentalität:  Abschnitt 2 (störungsanfällig, Active Couch Potato).
 *   - NEAT:                Abschnitt 3 (Bewegung außerhalb des Trainings).
 *   - Konkrete Hebel:      Abschnitt 4 (sechs Alltagsbewegungs-Hebel, Schritte-Skala).
 *   - 80-20-Prinzip:       Abschnitt 5.
 *   - Brücke zu Modul 4:   Abschnitt 6.
 *   - Workbook + Modul-3-Abschluss: Abschnitt 7.
 * Keine klassischen Übungen — eine Konzept-/Lebensweise-Lektion. Aufbau identisch
 * zu 3.1/3.2/3.3:
 ...
 * NICHT vertont.
 *
 * 3.-PERSON-REGEL (angewandt): 3.4 enthält zwei Stellen mit persönlichem
 * Ersteller-Ich (kein generischer Guide-„wir"), die auf „Max Glawe" umgeschrieben
 * wurden:
 *   - MD: „Eine letzte Idee, mit der ich Patienten oft arbeite: das 80-20-Prinzip."
 *     → „Eine letzte Idee, mit der Max Glawe Patienten oft arbeitet: das 80-20-Prinzip."
 *   - MD: „Modul 4 ist – ehrlich gesagt – mein Lieblingsteil der Masterclass."
 *     → „Modul 4 ist – ehrlich gesagt – Max Glawes Lieblingsteil der Masterclass."
 *   Generische Guide-/Wir-Form bleibt unverändert („Genau diese Frage beantworten
 *   wir im nächsten Modul.").
 *
 * HWG: Wortlaut der MD wird – außer der 3.-Person-Umschreibung – beibehalten.
 *   Alltagsbewegung/NEAT sind als allgemeine Lebensweise und Orientierung
 *   formuliert (Studienlage „zeigt konsistent", „profitiert messbar", Faustregeln),
 *   NICHT als medizinisches Heilversprechen. Die Schritt-Zahlen und Kalorien-
 *   Größenordnungen bleiben als grobe Orientierung wie in der MD stehen.
 *
...
const abschnitt1: SourceSection = {
  ...
  slides: [
    ...
    {
      type: "content",
      seg: "Willkommen zur letzten Lektion von Modul 3. Diese Lektion ist gleichzeitig der Abschluss des Präventions-Moduls und die direkte Brücke zu Modul 4 – dem Recoping-Modul mit Habit Stacking.",
    ...
    {
      type: "content",
      seg: " Worum geht es? Um eine Verschiebung deines Bewegungs-Verständnisses. Weg von der Workout-Mentalität – also dem Konzept, dass Bewegung in fest umrissenen Trainingseinheiten stattfindet, idealerweise zwei- bis dreimal pro Woche im Sportstudio – hin zu einer Bewegungs-Lebensweise: Bewegung als kontinuierliche Hintergrundmusik deines Tages, immer und überall.",
    ...
    {
      type: "statement",
      seg: " Diese Verschiebung ist nicht nur philosophisch. Sie ist messbar wichtiger für chronischen Schmerz als jede Trainingseinheit.",
...
// ── Abschnitt 2 – Das Problem mit der Workout-Mentalität ─────────────────────
...
const abschnitt2: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Viele Menschen denken über Bewegung so: Ich muss dreimal pro Woche Sport machen, um gesund zu sein. Das ist die Workout-Mentalität. Bewegung als Termin. Bewegung als abgeschlossene Einheit. Bewegung als Pflicht, die man hinter sich bringt.",
    ...
    {
      type: "content",
      seg: " Diese Mentalität hat zwei Probleme. Erstens: Sie ist störungsanfällig. Eine Erkältung, eine Reise, eine stressige Arbeitswoche – und der Trainings-Termin fällt aus. Ein, zwei verpasste Wochen, und der ganze Rhythmus bricht zusammen. Wer Bewegung nur als wöchentlichen Termin kennt, hat in Wirklichkeit oft viel weniger Bewegung als gedacht.",
    ...
    {
      type: "content",
      seg: " Zweitens: Sie macht 23 Stunden am Tag zu Nicht-Bewegungs-Zeit. Du machst eine Stunde Training, super. Was machst du in den anderen 23 Stunden? Sitzen, liegen, wenig laufen. Forschende sprechen hier vom Active Couch Potato Syndrome – Menschen, die zwar trainieren, aber den Rest des Tages bewegungsarm sind. Studien zeigen: Diese Menschen haben fast genauso hohe Gesundheitsrisiken wie Menschen, die gar nicht trainieren.",
      dark: true,
    ...
    {
      type: "statement",
      seg: " Für chronischen Rückenschmerz ist das besonders relevant. Dein Rücken liebt nicht eine intensive Trainingsstunde gefolgt von langem Sitzen. Er liebt viele kleine Bewegungs-Impulse über den Tag verteilt. Genau das, was die Workout-Mentalität nicht liefert.",
...
// ── Abschnitt 3 – NEAT: Bewegung außerhalb des Trainings ─────────────────────
...
const abschnitt3: SourceSection = {
  ...
  slides: [
    {
      type: "term",
      seg: "Es gibt einen technischen Begriff für die Bewegung, die du außerhalb von Training machst: NEAT – Non-Exercise Activity Thermogenesis. Wörtlich übersetzt: Bewegungs-Energieverbrauch außerhalb von Sport.",
      kicker: "Non-Exercise Activity Thermogenesis",
      term: "NEAT",
    },
    {
      type: "reveal-list",
      seg: " NEAT umfasst: Aufstehen, Gehen, Treppensteigen, Einkaufen, Wäsche aufhängen, Garten machen, Wackeln, Zappeln, Stehen statt Sitzen, Tippen, Gestikulieren. Alles, was nicht bewusster Sport ist, aber Bewegung.",
      kicker: "Was NEAT umfasst",
      title: "Bewegung, die nicht Sport ist",
      items: [
        { label: "Aufstehen, Gehen, Treppensteigen" },
        { label: "Einkaufen, Wäsche aufhängen, Garten machen" },
        { label: "Wackeln, Zappeln, Stehen statt Sitzen" },
        { label: "Tippen, Gestikulieren" },
      ],
    },
    {
      type: "content",
      seg: " Studien der letzten zwanzig Jahre zeigen konsistent: Menschen mit hohem NEAT sind gesünder, haben weniger chronische Schmerzen, sind belastbarer – auch wenn sie kein dediziertes Training machen. NEAT ist eine Art Grundrauschen an Bewegung, das alles andere fundamentiert.",
    ...
    {
      type: "content",
      seg: " Konkrete Größenordnung: Es gibt einen Unterschied von mehreren hundert Kalorien pro Tag zwischen Menschen mit hohem und niedrigem NEAT – allein durch Mikro-Bewegungen, ohne dass jemand Sport macht. Über ein Jahr summiert sich das zu erheblichen Belastungs-Unterschieden für Muskeln, Knochen, Bandscheiben.",
    ...
    {
      type: "statement",
      seg: " Was bedeutet das für dich? Wenn du chronisch hohen NEAT aufbaust, hast du eine Belastbarkeit, die wenig wackelt – auch wenn dein dediziertes Training mal ausfällt. NEAT ist robuster gegen Lebensstörungen als Workout-Routine.",
...
// ── Abschnitt 4 – Konkrete Alltagsbewegungen ─────────────────────────────────
...
const abschnitt4: SourceSection = {
  ...
  slides: [
    {
      type: "reveal-list",
      seg: "Wie baust du NEAT in deinem Alltag auf? Hier sind die wirksamsten Hebel.",
      kicker: "Die wirksamsten Hebel",
      title: "Sechs Hebel für mehr NEAT",
      items: [
        { label: "Gehen" },
        { label: "Treppen" },
        { label: "Aktivere Wahlentscheidungen" },
        { label: "Stehende Aktivitäten" },
        { label: "Pausen aktiv gestalten" },
        { label: "Wochenenden als Bewegungs-Ressource" },
      ],
    },
    {
      type: "content",
      seg: " Erstens: Gehen. Der einfachste, billigste, unterschätzteste Hebel.",
      kicker: "Hebel 1 · Gehen",
      headline: "Der einfachste, billigste, unterschätzteste Hebel.",
    },
    {
      type: "stats",
      seg: " Wer täglich 6.000 bis 10.000 Schritte geht, hat ein deutlich besseres Gesundheitsprofil als wer 2.000 Schritte geht. Das ist keine raketenwissenschaftliche Zahl – das ist im Alltag erreichbar.",
      stats: [
        { value: "2.000", label: "Schritte – wenig" },
        { value: "6.000", label: "Schritte – deutlich besser" },
        { value: "10.000", label: "Schritte – Alltagsziel" },
      ],
    },
    {
      type: "content",
      seg: " Statt zur Arbeit zu fahren, ein Teil davon zu laufen. Die Mittagspause draußen verbringen. Nach dem Abendessen eine Runde drehen.",
    ...
    {
      type: "content",
      seg: " Zweitens: Treppen. Treppen sind ein perfektes Mini-Krafttraining. Du belastest deine Beine, deinen Rumpf, dein Herz-Kreislauf-System. Wo immer Aufzüge sind, nimm Treppen. Bewusst. Es kostet zwei Minuten mehr und es schenkt dir eine kleine Trainingseinheit.",
    ...
    {
      type: "content",
      seg: " Drittens: Aktivere Wahlentscheidungen. Parkplatz weiter weg vom Eingang. Tagesziele zu Fuß erledigen statt mit Auto. Einkäufe nicht alle auf einmal, sondern dreimal pro Woche eine kleine Runde. Solche Mini-Entscheidungen summieren sich.",
    ...
    {
      type: "content",
      seg: " Viertens: Stehende Aktivitäten. Manche Aufgaben, die du normalerweise sitzend machst, kannst du stehend machen. Telefonieren im Stehen. E-Mails am Stehpult. Mit der Familie nicht auf dem Sofa, sondern im Stehen kurze Gespräche.",
    ...
    {
      type: "content",
      seg: " Fünftens: Pausen aktiv gestalten. Statt in der Pause das Handy zu checken, geh fünf Minuten draußen. Mach drei Hip Hinges. Eine Cat-Cow. Die Mobilisationen aus Modul 2 sind so kurz, dass du sie als Pausen-Füller einbauen kannst.",
    ...
    {
      type: "content",
      seg: " Sechstens: Wochenenden als Bewegungs-Ressource. Wandern, Radfahren, Schwimmen, im Garten arbeiten, mit Kindern oder Enkeln rumtoben. Solche Aktivitäten sind nicht Sport im engeren Sinne, aber sie sind Bewegung, die Spaß macht und Stunden anhält. Dafür sind Wochenenden ideal.",
...
const abschnitt5: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Eine letzte Idee, mit der Max Glawe Patienten oft arbeitet: das 80-20-Prinzip für Bewegung. Das Prinzip lautet: Ungefähr 80 Prozent der Wirkung kommen aus Alltagsbewegung – NEAT, Gehen, Treppen, kleine Routinen. Etwa 20 Prozent der Wirkung kommen aus dediziertem Training – Stabilisation, Krafttraining, Sport.",
    ...
    {
      type: "stats",
      seg: " Wenn du es umgekehrt versuchst – also 80 Prozent deiner Energie in dediziertes Training steckst und die anderen 80 Prozent des Tages bewegungsarm bist – kämpfst du gegen Schwerkraft. Wenn du es richtig herum machst – 80 Prozent leichte aber kontinuierliche Bewegung, 20 Prozent fokussiertes Training – kriegst du mehr Wirkung mit weniger Aufwand.",
      stats: [
        { value: "80%", label: "Alltagsbewegung" },
        { value: "20%", label: "fokussiertes Training" },
        { value: "mehr", label: "Wirkung, weniger Aufwand" },
      ],
    },
    {
      type: "statement",
      seg: " Das heißt nicht, dass Training unwichtig ist. Modul 2 bleibt absolut wichtig. Aber Training läuft am besten, wenn es auf einem Fundament hoher Alltagsbewegung sitzt. Wer wenig sitzt, viel geht, regelmäßig die Treppe nimmt – der profitiert von einer Stabilisations-Einheit pro Woche viel mehr als jemand, der den ganzen Tag sitzt und am Wochenende krampfhaft trainiert.",
...
const abschnitt6: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Vielleicht denkst du gerade: Das klingt alles vernünftig, aber wie soll ich das im Alltag wirklich umsetzen, wenn ich es immer wieder vergesse? Genau diese Frage beantworten wir im nächsten Modul.",
    ...
    {
      type: "content",
      seg: " Modul 4 heißt Recoping – schmerzadaptive Wiedereingliederung von Ritualen. Du lernst dort konkret, wie du Bewegung, Atmung, Pacing in deinen Tagesablauf einknüpfst, sodass sie automatisch passieren, ohne dass du dich permanent erinnern musst. Du wirst lernen, was Habit Stacking heißt, und du wirst deine eigene Ritual-Map erstellen – ein persönliches System aus Tages-Ankern und Mini-Übungen, das deinen Alltag von innen verändert.",
    ...
    {
      type: "statement",
      seg: " Modul 4 ist – ehrlich gesagt – Max Glawes Lieblingsteil der Masterclass. Hier wird die Theorie zur Praxis im echten Sinne. Vorbereiten dafür musst du nichts – du bist schon mit allem ausgestattet, was du brauchst.",
...
// ── Abschnitt 7 – Workbook und Modul-3-Abschluss ─────────────────────────────
...
const abschnitt7: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Im Workbook findest du Übung 3.4: Mein Alltags-Bewegungs-Inventar. Du listest dort, wann und wie du dich aktuell schon im Alltag bewegst – und identifizierst drei Punkte, an denen du mehr NEAT einbauen könntest. Ohne große Pläne, ohne Sport-Verträge. Einfach drei kleine Verschiebungen.",
    ...
    {
      type: "reveal-list",
      seg: " Damit ist Modul 3 abgeschlossen. Du hast jetzt: ein Belastbarkeits-Mindset statt eines Schonungs-Reflexes aus 3.1, Befreiung von rigiden Haltungs-Vorstellungen aus 3.2, drei Lifestyle-Hebel – Schlaf, Stress, Ernährung – aus 3.3, und eine NEAT- und 80-20-Idee für Alltagsbewegung aus 3.4.",
      kicker: "Modul 3 abgeschlossen",
      title: "Das nimmst du aus Modul 3 mit",
      items: [
        { label: "Belastbarkeits-Mindset statt Schonungs-Reflex (3.1)" },
        { label: "Befreiung von rigiden Haltungs-Vorstellungen (3.2)" },
        { label: "Drei Lifestyle-Hebel: Schlaf, Stress, Ernährung (3.3)" },
        { label: "NEAT und das 80-20-Prinzip für Alltagsbewegung (3.4)" },
      ],
    },
    {
      type: "content",
      seg: " Bevor du in Modul 4 startest – mach wieder einen Tag Pause. Schau, was von Modul 3 zu dir spricht und was du als nächstes umsetzen willst. Modul 4 ist dann die direkte Anwendungs-Anleitung dafür.",
