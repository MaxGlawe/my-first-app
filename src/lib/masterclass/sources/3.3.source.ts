/**
 * Masterclass „Chronischer Kreuzschmerz" — Source of Truth für Lektion 3.3
 * ========================================================================
 *
 * DIES IST DIE QUELLE. `src/lib/masterclass/lessons/3.3.ts` wird DARAUS generiert
 * (via `node scripts/build-masterclass.mjs 3.3`). Niemals lessons/3.3.ts von Hand
 * editieren — immer hier ändern und das Build-Skript neu laufen lassen.
 *
 * Dritte Lektion von Modul 3 (Prävention) und die längste des Moduls. „Schlaf,
 * Stress, Ernährung als Schmerzmodulatoren": die drei unsichtbaren Schmerz-
 * modulatoren als eigene Themenblöcke / Slide-Gruppen klar getrennt:
 *   - Schlaf-Block:    Abschnitt 2 (der unterschätzte Schmerz-Hebel, Teufelskreis,
 *                      sechs Basics).
 *   - Stress-Block:    Abschnitt 3 (das parallele Schmerzsystem, vier Werkzeuge).
 *   - Ernährungs-Block: Abschnitt 4 (keine Wunderdiät, fünf Basis-Erkenntnisse).
 * Danach Integration ohne Überforderung (Abschnitt 5) und Workbook + Übergang zu
 * 3.4 (Abschnitt 6). Keine klassischen Übungen — eine Lebensstil-Orientierungs-
 * Lektion. Aufbau identisch zu 3.1/3.2:
 ...
 * NICHT vertont.
 *
 * 3.-PERSON-REGEL (angewandt): 3.3 enthält vier Stellen mit persönlichem
 * Ersteller-/Empfehlungs-Ich (kein generischer Guide-„wir"), die auf „Max Glawe"
 * umgeschrieben wurden:
 *   - MD: „Wenn ich nur einen Lifestyle-Faktor priorisieren müsste – es wäre Schlaf."
 *     → „Wenn Max Glawe nur einen Lifestyle-Faktor priorisieren müsste – es wäre Schlaf."
 *   - MD: „Mein Tipp: kein Koffein nach 14 Uhr."
 *     → „Der Tipp von Max Glawe: kein Koffein nach 14 Uhr."
 *   - MD: „einige Basis-Erkenntnisse … die ich dir mitgeben möchte."
 *     → „… die Max Glawe dir mitgeben möchte."
 *   - MD: „Mein Vorschlag: Pick eine Sache aus."
 *     → „Der Vorschlag von Max Glawe: Pick eine Sache aus."
 *   Die übrige Du-/Wir-Anleitungsform bleibt unverändert.
 *
 * HWG (BESONDERS RELEVANT — Schlaf/Stress/Ernährung): Wortlaut der MD wird – außer
 *   der 3.-Person-Umschreibung – beibehalten. Alle drei Faktoren sind als
 *   allgemeine Schmerzmodulatoren / Lebensstil-Orientierung formuliert, NICHT als
 *   medizinische Heilversprechen und KEINE Ernährungs-Therapie-Versprechen. Die
 *   abgrenzenden MD-Sätze bleiben erhalten und unverändert: schlafmedizinische
 *   Abklärung bei länger anhaltenden Schlafstörungen, professionelle Unterstützung
 *   bei anhaltendem Stress / Depression / Angst / Burnout, ärztliche Vitamin-D-
 *   Messung, „diese Masterclass ersetzt das nicht". Empfehlungen sind als
 *   Orientierung/„kann", „profitiert messbar", „Faustregel" formuliert.
 *
...
const abschnitt1: SourceSection = {
  ...
  slides: [
    ...
    {
      type: "module",
      seg: "Willkommen zur längsten Lektion von Modul 3. Wir behandeln heute drei Themen, die untrennbar zusammenhängen, wenn es um chronischen Schmerz geht: Schlaf, Stress, Ernährung.",
      number: "3.3",
    ...
    {
      type: "content",
      seg: " Diese drei sind das, was man gerne die unsichtbaren Schmerzmodulatoren nennt. Sie machen nicht den Schmerz – aber sie entscheiden mit, wie laut dein Schmerzsystem heute spricht. Wer chronischen Schmerz hat und diese drei Faktoren vernachlässigt, kämpft mit einem Bein gefesselt. Wer sie versteht und ein bisschen pflegt, hat einen massiven Hebel.",
    ...
    {
      type: "content",
      seg: " Wichtig vorab: Diese Lektion wird keine Wunderdiäten anbieten, keine Schlaf-Optimierungs-Hacks, kein Bio-Hacking. Wir bleiben bei dem, was die Forschung wirklich gut belegt – und was sich realistisch im Alltag umsetzen lässt.",
...
// ── Abschnitt 2 – SCHLAF: Der unterschätzte Schmerz-Hebel ────────────────────
...
const abschnitt2: SourceSection = {
  ...
  slides: [
    {
      type: "statement",
      seg: "Beginnen wir mit Schlaf. Wenn Max Glawe nur einen Lifestyle-Faktor priorisieren müsste – es wäre Schlaf.",
      text: "Schlaf ist die wichtigste regenerative Zeit deines Schmerzsystems.",
      emphasis: "Schlaf",
    },
    {
      type: "content",
      seg: " Warum ist Schlaf so wichtig für chronischen Schmerz? Mehrere Mechanismen wirken zusammen. Erstens: Schlaf ist die Hauptregenerationszeit deines Nervensystems. Während du schläfst, werden Entzündungsstoffe abgebaut, Nervenverbindungen umgeordnet, die Sensitivität deines Schmerzsystems neu kalibriert. Wer schlecht schläft, geht mit einem aufgedrehten System in den Tag.",
    ...
    {
      type: "content",
      seg: " Zweitens: Schlafmangel senkt direkt die Schmerzschwelle. Mehrere Studien zeigen: Schon eine einzige durchwachte Nacht reduziert die Schmerztoleranz messbar. Chronischer Schlafmangel über Wochen ist ein eigenständiger Risikofaktor für die Chronifizierung von Schmerz.",
    ...
    {
      type: "content",
      seg: " Drittens: Schlafstörungen und chronischer Schmerz bilden einen Teufelskreis. Schmerz stört den Schlaf, schlechter Schlaf verstärkt den Schmerz, mehr Schmerz stört wieder den Schlaf. Diesen Zyklus zu durchbrechen, ist eines der effektivsten Dinge, die du tun kannst.",
      dark: true,
    ...
    {
      type: "content",
      seg: " Was funktioniert? Wir reden hier nicht über exotische Tricks. Die Basics sind das, was wirklich zählt.",
      kicker: "Was funktioniert",
      headline: "Keine exotischen Tricks – die Basics sind das, was wirklich zählt.",
    },
    {
      type: "content",
      seg: " Regelmäßige Schlafzeiten. Dein Körper liebt Rhythmus. Wenn du jeden Tag ungefähr zur selben Zeit ins Bett gehst und aufstehst, kalibriert sich dein Schlafsystem. Schwankungen von zwei oder drei Stunden – zum Beispiel am Wochenende viel länger schlafen – stören das. Eine Schwankung von 30 bis 60 Minuten ist okay.",
    ...
    {
      type: "content",
      seg: " Sieben bis neun Stunden im Bett. Die Bandbreite ist individuell, aber für die meisten Menschen liegt das gesunde Maß in diesem Bereich. Weniger als sechs Stunden chronisch ist ein eigenständiger Risikofaktor für alles Mögliche, inklusive Schmerz.",
    ...
    {
      type: "content",
      seg: " Dunkler, kühler, ruhiger Schlafraum. Klingt banal, ist aber Grundlage. Verdunkelnde Vorhänge, leicht kühle Temperatur, etwa 16 bis 19 Grad, Ohrstöpsel bei Geräuschempfindlichkeit. Smartphone und Fernseher gehören nicht ins Bett.",
    ...
    {
      type: "content",
      seg: " Abendliche Beruhigung. In den letzten 60 bis 90 Minuten vor dem Schlaf läuft idealerweise nichts mehr Aufregendes. Kein intensiver Sport, keine wichtigen Entscheidungen, keine Streit-Gespräche, kein endloses Social Media. Stattdessen: Lesen, ruhige Musik, Bad, Atemübung. Box Breathing aus Lektion 2.5 ist hier ein ausgezeichnetes Werkzeug.",
    ...
    {
      type: "content",
      seg: " Koffein-Schnitt. Koffein hat eine Halbwertszeit von fünf bis sieben Stunden. Wer um 15 Uhr noch einen Espresso trinkt, hat um Mitternacht noch die Hälfte der Wirkung im Blut. Der Tipp von Max Glawe: kein Koffein nach 14 Uhr. Wenn das schwer ist, geh schrittweise vor.",
    ...
    {
      type: "content",
      seg: " Alkohol-Vorsicht. Alkohol macht dich müde, aber er stört die Schlafqualität – vor allem die zweite Nachthälfte. Wer regelmäßig schlecht schläft und abends Alkohol trinkt, kann durch Reduktion oft schon viel verbessern.",
    ...
    {
      type: "content",
      seg: " Wenn du an Schlafstörungen leidest, die sich nicht durch diese Basics verbessern – etwa Ein- oder Durchschlafstörungen über mehr als drei Monate – dann ist eine schlafmedizinische Abklärung sinnvoll. Diese Masterclass ersetzt das nicht.",
      dark: true,
...
const abschnitt3: SourceSection = {
  ...
  slides: [
    ...
    {
      type: "reveal-list",
      seg: " Klassische Stress-Quellen bei chronischen Schmerzpatienten: Berufliche Überforderung. Konflikte am Arbeitsplatz. Familiäre Belastung – kranke Angehörige, schwierige Beziehungen. Finanzielle Sorgen. Soziale Isolation. Und – das wird oft übersehen – der chronische Schmerz selbst. Wer Schmerz hat, ist gestresst von dem Schmerz. Das ist ein eigener Stressfaktor, der sich selbst verstärkt.",
      kicker: "Klassische Stress-Quellen",
      title: "Wo der Stress herkommt",
      items: [
        { label: "Berufliche Überforderung & Konflikte am Arbeitsplatz" },
        { label: "Familiäre Belastung – kranke Angehörige, schwierige Beziehungen" },
        { label: "Finanzielle Sorgen" },
        { label: "Soziale Isolation" },
        { label: "Der chronische Schmerz selbst – ein eigener Stressfaktor" },
      ],
    },
    {
      type: "content",
      seg: " Was kannst du tun? Vier Werkzeuge, die nachweislich wirken. Erstens: Atemübungen. Wir hatten das in Lektion 2.5. Box Breathing, 360-Grad-Atmung. Diese Tools sind die direktesten Hebel ans vegetative Nervensystem, die du hast. Drei Minuten Box Breathing ein paar Mal am Tag senken dein Stress-Niveau messbar. Das ist Forschung, nicht Esoterik.",
    ...
    {
      type: "content",
      seg: " Zweitens: Bewegung. Bewegung ist eines der wirksamsten Antidepressiva und Antistress-Mittel überhaupt. Regelmäßige moderate Bewegung – nicht extremer Sport, sondern moderate Belastung dreimal pro Woche – reduziert Stresshormone, verbessert Stimmung, normalisiert Schlaf. Das ist gleichzeitig dein Schmerztraining – also doppelt nützlich.",
    ...
    {
      type: "content",
      seg: " Drittens: Soziale Verbindung. Menschen mit gutem sozialen Netz haben weniger Stresshormone im Blut, schlafen besser, haben weniger chronischen Schmerz. Wer im chronischen Schmerz isoliert lebt, sollte aktiv etwas dagegen tun – Familie, Freunde, Vereine, Gruppen. Eine Stunde guter Kontakt ist therapeutisch.",
    ...
    {
      type: "content",
      seg: " Viertens: Was loslassen. Das ist das schwierigste der vier. Manchmal ist Stress unausweichlich, aber oft ist er durch Überverantwortung erzeugt. Wer chronisch alles schaffen will, alle Erwartungen erfüllen, allen helfen – baut sich seinen eigenen Stress. Manchmal ist die Antwort: ein Projekt abgeben. Ein Ehrenamt beenden. Ein Mal Nein sagen. Das ist nicht egoistisch – das ist Selbsterhaltung.",
    ...
    {
      type: "content",
      seg: " Wenn dein Stress so anhaltend ist, dass du dich überfordert fühlst, oder wenn Depression, Angst oder Burnout-Symptome dazukommen – dann ist professionelle Unterstützung sinnvoll. Eine Psychotherapie oder eine ärztlich begleitete Stress-Beratung kann viel verändern, parallel zu dieser Masterclass.",
      dark: true,
      kicker: "Wichtiger Hinweis",
...
// ── Abschnitt 4 – ERNÄHRUNG: Keine Wunderdiät, aber wichtige Basics ──────────
...
const abschnitt4: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Dritter Faktor: Ernährung. Hier wird es interessant, weil im Internet eine riesige Industrie zu diesem Thema unterwegs ist. Anti-entzündliche Diäten, ketogen, paleo, vegan, intermittierendes Fasten, alles wird gegen chronischen Schmerz beworben. Was davon stimmt? Erstaunlich wenig in der spezifischen Form. Aber: Es gibt einige Basis-Erkenntnisse, die wissenschaftlich gut belegt sind und die Max Glawe dir mitgeben möchte.",
    ...
    {
      type: "content",
      seg: " Erkenntnis 1: Vermeide stark verarbeitete Lebensmittel. Industrielle Backwaren, Fertiggerichte, Wurst, Süßigkeiten, sehr zuckerhaltige Getränke – diese Lebensmittelgruppe ist konsistent mit erhöhter systemischer Entzündung verbunden. Systemische Entzündung ist nicht die Ursache chronischen Schmerzes, aber sie senkt die Schmerzschwelle und verstärkt das Schmerzempfinden.",
    ...
    {
      type: "content",
      seg: " Wie sieht das praktisch aus? Du musst nicht alles aus deinem Leben streichen. Aber: Erhöhe den Anteil unverarbeiteter Lebensmittel – Gemüse, Obst, Hülsenfrüchte, Vollkorn, Nüsse, Fisch, gutes Fleisch, gute Öle. Reduziere den Anteil hochverarbeiteter Industrie-Produkte. Das ist keine Diät, das ist Ernährungs-Hygiene.",
      kicker: "Praktisch",
    ...
    {
      type: "content",
      seg: " Erkenntnis 2: Genug Protein. Bei chronischem Schmerz wird Gewebe ständig umgebaut – Muskeln, Sehnen, Bindegewebe, Nervenzellen. Diese Umbauten brauchen Eiweiß als Baustein. Wer zu wenig Protein isst, hat schlechtere Regeneration, schlechtere Muskelbildung, schlechtere Schmerzheilung.",
    ...
    {
      type: "content",
      seg: " Faustregel: etwa 1 bis 1,2 Gramm Protein pro Kilogramm Körpergewicht und Tag. Wer 70 Kilo wiegt, braucht also 70 bis 85 Gramm Protein. Das sind etwa drei eiweißreiche Mahlzeiten pro Tag – Eier zum Frühstück, Hülsenfrüchte oder Fleisch und Fisch zum Mittag, Quark oder Skyr zum Abend. Bei intensivem Training oder über 60 Jahren eher mehr – bis 1,5 Gramm pro Kilo.",
    ...
    {
      type: "content",
      seg: " Erkenntnis 3: Omega-3-Fettsäuren. Diese Fettsäuren – vor allem aus fettem Seefisch, Leinöl, Walnüssen, Chia-Samen – wirken entzündungshemmend. Wer regelmäßig zwei Portionen fetten Seefisch pro Woche isst, oder alternativ eine gute Omega-3-Ergänzung nimmt, profitiert messbar.",
    ...
    {
      type: "content",
      seg: " Erkenntnis 4: Vitamin D. In Deutschland ist Vitamin-D-Mangel weit verbreitet, vor allem im Winter. Mehrere Studien zeigen Zusammenhänge zwischen niedrigem Vitamin D und chronischen Schmerzzuständen, vor allem muskulären Schmerzen. Lass deinen Wert einmal ärztlich messen. Wenn er niedrig ist, supplementiere – meistens reicht eine moderate Tagesdosis aus.",
    ...
    {
      type: "content",
      seg: " Erkenntnis 5: Hydration. Klingt banal, ist aber relevant. Bandscheiben bestehen zu 75 bis 90 Prozent aus Wasser. Wer chronisch dehydriert ist, hat schlechtere Bandscheibenfunktion. Faustregel: anderthalb bis zwei Liter Wasser pro Tag, mehr bei intensivem Training oder Hitze.",
    ...
    {
      type: "content",
      seg: " Was nicht funktioniert: Spezielle Anti-Schmerz-Diäten ohne medizinischen Hintergrund. Wer keine Glutenunverträglichkeit hat, hat keinen Vorteil von glutenfreier Ernährung. Wer keinen erhöhten Harnsäurewert hat, profitiert nicht von purinarmer Ernährung. Lass dich nicht in eine Diät treiben, die du nicht brauchst.",
      dark: true,
...
// ── Abschnitt 5 – Wie integrieren ohne Überforderung ─────────────────────────
...
const abschnitt5: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Drei Themen – Schlaf, Stress, Ernährung. Das könnte überwältigend wirken. Wie integrierst du das, ohne dich zu überfordern? Der Vorschlag von Max Glawe: Pick eine Sache aus. Nicht alle drei gleichzeitig.",
    ...
    {
      type: "content",
      seg: " Wenn du schlecht schläfst, beginn mit Schlaf. Setz dir das Ziel, eine Schlafhygiene-Basis aufzubauen – regelmäßige Zeiten, kein Koffein nach 14 Uhr, dunkler Raum. Gib dir vier Wochen, das stabil zu integrieren.",
    ...
    {
      type: "content",
      seg: " Wenn du sehr gestresst bist, beginn mit Stress. Wähle ein konkretes Werkzeug – Box Breathing dreimal täglich, oder einen wöchentlichen längeren Spaziergang, oder eine soziale Verabredung pro Woche.",
    ...
    {
      type: "content",
      seg: " Wenn du dich generell schlecht ernährst, beginn mit Ernährung. Eine konkrete Änderung – mehr Gemüse zum Mittag, oder ein Protein-Frühstück, oder Vitamin-D-Wert messen lassen.",
    ...
    {
      type: "statement",
      seg: " Erst wenn die erste Sache stabil läuft – die zweite anpacken. Lieber langsam und konsistent als schnell und unhaltbar.",
...
const abschnitt6: SourceSection = {
  ...
  slides: [
    {
      type: "content",
      seg: "Im Workbook findest du Übung 3.3: Lifestyle-Scan. Drei kurze Selbst-Audits – wie steht es bei dir um Schlaf, Stress, Ernährung? Du markierst, wo du dich gut versorgst, wo es Verbesserungs-Potenzial gibt. Plus ein Feld: Welche eine Sache fange ich in den nächsten vier Wochen an?",
    ...
    {
      type: "content",
      seg: " In der letzten Lektion von Modul 3 – Lektion 3.4 – geht es um Alltagsbewegung. Wie kommst du raus aus der Workout-Mentalität – Ich muss dreimal pro Woche Sport machen – und rein in eine Bewegungs-Lebensweise, in der Bewegung kein Termin ist, sondern dauerhafte Hintergrundmusik deines Tages.",
