/**
 * Masterclass „Chronischer Kreuzschmerz" — Laufzeit-Daten der Lektion 2.7
 * Schmerz-Coping in der Praxis
 *
 * ⚠️  GENERIERT — NICHT VON HAND EDITIEREN.
 * Quelle:   src/lib/masterclass/sources/2.7.source.ts
 * Erzeugt:  node scripts/build-masterclass.mjs 2.7  (Stimme: Adrian / YYyi4prp0WCqZCPDNGu1)
...
const AUDIO_BASE = "/audio/masterclass/chronischer-kreuzschmerz/2.7";
  ...
  sections: [
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"Graded Exposure – schrittweises Wieder-Annähern an gefürchtete Bewegungen"},{"label":"Kognitive Defusion – Abstand nehmen von Schmerz-Gedanken, ohne sie zu unterdrücken"}],
        },
      ],
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"Du erlebst Schmerz"},{"label":"Dein Hirn bewertet: diese Bewegung ist gefährlich"},{"label":"Du entwickelst Angst vor der Bewegung"},{"label":"Du vermeidest die Bewegung"},{"label":"Keine Korrektur-Erfahrung – die Bewertung bleibt: gefährlich"},{"label":"Beim nächsten Mal: mehr Schmerz, mehr Angst"}],
        },
        {
          type: "content",
          appearTime: 32.183,
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"Hip Hinge ohne Last bis zu den Knien"},{"label":"Leere Flasche aus halber Höhe vom Tisch"},{"label":"Leere Flasche vom Boden"},{"label":"Halbvolle Flasche"},{"label":"Volle Flasche"},{"label":"Zwei Flaschen"},{"label":"Eine richtige Einkaufstasche"}],
        },
        {
          type: "content",
          appearTime: 100.009,
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"„Ich habe gerade den Gedanken, dass …“"},{"label":"Naming the thought – dem Gedanken einen Namen geben"},{"label":"Singen oder fremde Stimme – das Absurde nutzen"}],
        },
        {
          type: "statement",
          appearTime: 80.399,
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"An schlechten Schmerz-Tagen, wenn Übung schwer ist"},{"label":"In Stress-Phasen, in denen der Schmerz reaktiv hochfährt"},{"label":"Bei gefürchteten Aktivitäten, vor denen du seit Jahren wegläufst"},{"label":"Im Wartezimmer, im Auto, in der Nacht"}],
        },
        {
          type: "reveal-list",
          appearTime: 31.01,
          ...
          title: "Klare Grenzen",
          items: [{"label":"Ärztliche Diagnostik bei Red Flags"},{"label":"Körperliche Bewegungstherapie"},{"label":"Bei Depression, Angststörung, PTBS: spezialisierte Psychotherapie – parallel"}],
        },
      ],
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          items: [{"label":"Sieben Mobilisationsübungen · 2.2"},{"label":"Sechs Stabilisationsübungen · 2.3"},{"label":"Sieben Belastungstoleranz-Übungen · 2.4"},{"label":"Drei Atemübungen · 2.5"},{"label":"Pacing-Prinzipien · 2.6"},{"label":"Mentale Coping-Werkzeuge · 2.7"}],
        },
        {
          type: "content",
          appearTime: 47.288,
...
export const total_2_7: number = totalSlides(lesson_2_7);

/** Flache Liste aller Slides (mit Rückverweis auf den Abschnitt). */
export const flat_2_7: FlatSlide[] = flatSlides(lesson_2_7);

export default lesson_2_7;
