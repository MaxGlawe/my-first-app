...
const PILLARS = [
  ...
  {
    icon: PenLine,
    titel: "Interaktives Workbook",
    text: "Zu allen Lektionen zum Mitmachen direkt im Browser — Notizen speichern, Übungen ausfüllen und jederzeit als PDF ausdrucken.",
  },
  {
    icon: Layers,
    titel: "Bonus · Übungskartendeck",
    text: `${DECK_UEBUNGEN} Schlüsselübungen als Karten zum Durchblättern und Ausdrucken — dein Begleiter für unterwegs, inklusive.`,
  },
] as const
...
function PurchasePanel({ product }: { product: MasterclassProduct }) {
  ...
  return (
    ...
    >
      ...
      {/* Klarna-Hinweis (Ratenwahl erfolgt im Stripe-Checkout) */}
      <p className="-mt-1 text-center text-xs leading-relaxed" style={{ color: MUTED }}>
        … oder bequem in 3 Raten mit Klarna — ohne Aufpreis.
      </p>
