          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                <div className="h-64 w-64 sm:h-72 sm:w-72 lg:h-80 lg:w-80 rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/10 ring-1 ring-slate-100">
                  <img
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <span className="text-7xl sm:text-8xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent leading-none select-none block mb-4">
                &ldquo;
              </span>

              <blockquote className="text-xl sm:text-2xl lg:text-[1.7rem] font-light text-slate-800 leading-relaxed italic tracking-tight">
