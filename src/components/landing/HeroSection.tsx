...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-900">
      ...
      <div className="relative container mx-auto px-4 pt-32 pb-20 max-w-6xl">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="animate-fade-in-up animation-delay-150 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white leading-[1.05]">
            Ihre Therapie.
            <br />
